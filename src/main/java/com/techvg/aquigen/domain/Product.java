...
public class Product implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "quatationDetails", "products" }, allowSetters = true)
    private Categories categories;

    @ManyToOne
    @JsonIgnoreProperties(value = { "purchaseOrderDetails", "quatationDetails", "products" }, allowSetters = true)
    private Unit unit;
