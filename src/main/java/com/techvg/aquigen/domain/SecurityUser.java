...
public class SecurityUser implements Serializable {
    ...
    private Set<PurchaseOrder> purchaseOrderDetails = new HashSet<>();
    ...
    public Set<PurchaseOrder> getPurchaseOrderDetails() {
        return this.purchaseOrderDetails;
    }

    public void setPurchaseOrderDetails(Set<PurchaseOrder> purchaseOrders) {
        if (this.purchaseOrderDetails != null) {
            this.purchaseOrderDetails.forEach(i -> i.setSecurityUser(null));
        }
        if (purchaseOrders != null) {
            purchaseOrders.forEach(i -> i.setSecurityUser(this));
        }
        this.purchaseOrderDetails = purchaseOrders;
    }

    public SecurityUser purchaseOrderDetails(Set<PurchaseOrder> purchaseOrders) {
        this.setPurchaseOrderDetails(purchaseOrders);
        return this;
    }

    public SecurityUser addPurchaseOrderDetails(PurchaseOrder purchaseOrder) {
        this.purchaseOrderDetails.add(purchaseOrder);
        purchaseOrder.setSecurityUser(this);
        return this;
    }

    public SecurityUser removePurchaseOrderDetails(PurchaseOrder purchaseOrder) {
        this.purchaseOrderDetails.remove(purchaseOrder);
