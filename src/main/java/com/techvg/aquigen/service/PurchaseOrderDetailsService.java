package com.techvg.aquigen.service;

import com.techvg.aquigen.domain.PurchaseOrderDetails;
import com.techvg.aquigen.repository.PurchaseOrderDetailsRepository;
import com.techvg.aquigen.service.dto.PurchaseOrderDetailsDTO;
import com.techvg.aquigen.service.mapper.PurchaseOrderDetailsMapper;
...
public class PurchaseOrderDetailsService {
     ...
     * @return the list of entities.
     */
    public Page<PurchaseOrderDetailsDTO> findAllWithEagerRelationships(Pageable pageable) {
        return purchaseOrderDetailsRepository.findAllWithEagerRelationships(pageable).map(purchaseOrderDetailsMapper::toDto);
    }
    ...
    public Optional<PurchaseOrderDetailsDTO> findOne(Long id) {
        ...
        return purchaseOrderDetailsRepository.findOneWithEagerRelationships(id).map(purchaseOrderDetailsMapper::toDto);
    }
