package com.techvg.aquigen.web.rest;
...
import com.techvg.aquigen.domain.SecurityRole;
import com.techvg.aquigen.domain.SecurityUser;
import com.techvg.aquigen.domain.Transfer;
import com.techvg.aquigen.domain.Warehouse;
import com.techvg.aquigen.repository.SecurityUserRepository;
import com.techvg.aquigen.service.SecurityUserService;
import com.techvg.aquigen.service.criteria.SecurityUserCriteria;
import com.techvg.aquigen.service.dto.SecurityUserDTO;
import com.techvg.aquigen.service.mapper.SecurityUserMapper;
...
class SecurityUserResourceIT {
    ...
    void createSecurityUser() throws Exception {
        ...
        assertThat(testSecurityUser.getBusinessTitle()).isEqualTo(DEFAULT_BUSINESS_TITLE);
        assertThat(testSecurityUser.getgSTDetails()).isEqualTo(DEFAULT_G_ST_DETAILS);
    ...
    @Test
    @Transactional
    void getAllSecurityUsersByBusinessTitleIsEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where businessTitle equals to DEFAULT_BUSINESS_TITLE
        defaultSecurityUserShouldBeFound("businessTitle.equals=" + DEFAULT_BUSINESS_TITLE);

        // Get all the securityUserList where businessTitle equals to UPDATED_BUSINESS_TITLE
        defaultSecurityUserShouldNotBeFound("businessTitle.equals=" + UPDATED_BUSINESS_TITLE);
    }

    @Test
    @Transactional
    void getAllSecurityUsersByBusinessTitleIsNotEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where businessTitle not equals to DEFAULT_BUSINESS_TITLE
        defaultSecurityUserShouldNotBeFound("businessTitle.notEquals=" + DEFAULT_BUSINESS_TITLE);

        // Get all the securityUserList where businessTitle not equals to UPDATED_BUSINESS_TITLE
        defaultSecurityUserShouldBeFound("businessTitle.notEquals=" + UPDATED_BUSINESS_TITLE);
    }

    @Test
    @Transactional
    void getAllSecurityUsersByBusinessTitleIsInShouldWork() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where businessTitle in DEFAULT_BUSINESS_TITLE or UPDATED_BUSINESS_TITLE
        defaultSecurityUserShouldBeFound("businessTitle.in=" + DEFAULT_BUSINESS_TITLE + "," + UPDATED_BUSINESS_TITLE);

        // Get all the securityUserList where businessTitle equals to UPDATED_BUSINESS_TITLE
        defaultSecurityUserShouldNotBeFound("businessTitle.in=" + UPDATED_BUSINESS_TITLE);
    }

    @Test
    @Transactional
    void getAllSecurityUsersByBusinessTitleIsNullOrNotNull() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where businessTitle is not null
        defaultSecurityUserShouldBeFound("businessTitle.specified=true");

        // Get all the securityUserList where businessTitle is null
        defaultSecurityUserShouldNotBeFound("businessTitle.specified=false");
    }

    @Test
    @Transactional
    void getAllSecurityUsersByBusinessTitleContainsSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where businessTitle contains DEFAULT_BUSINESS_TITLE
        defaultSecurityUserShouldBeFound("businessTitle.contains=" + DEFAULT_BUSINESS_TITLE);

        // Get all the securityUserList where businessTitle contains UPDATED_BUSINESS_TITLE
        defaultSecurityUserShouldNotBeFound("businessTitle.contains=" + UPDATED_BUSINESS_TITLE);
    }

    @Test
    @Transactional
    void getAllSecurityUsersByBusinessTitleNotContainsSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where businessTitle does not contain DEFAULT_BUSINESS_TITLE
        defaultSecurityUserShouldNotBeFound("businessTitle.doesNotContain=" + DEFAULT_BUSINESS_TITLE);

        // Get all the securityUserList where businessTitle does not contain UPDATED_BUSINESS_TITLE
        defaultSecurityUserShouldBeFound("businessTitle.doesNotContain=" + UPDATED_BUSINESS_TITLE);
    }

    @Test
    @Transactional
    void getAllSecurityUsersBygSTDetailsIsEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where gSTDetails equals to DEFAULT_G_ST_DETAILS
        defaultSecurityUserShouldBeFound("gSTDetails.equals=" + DEFAULT_G_ST_DETAILS);

        // Get all the securityUserList where gSTDetails equals to UPDATED_G_ST_DETAILS
        defaultSecurityUserShouldNotBeFound("gSTDetails.equals=" + UPDATED_G_ST_DETAILS);
    }

    @Test
    @Transactional
    void getAllSecurityUsersBygSTDetailsIsNotEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where gSTDetails not equals to DEFAULT_G_ST_DETAILS
        defaultSecurityUserShouldNotBeFound("gSTDetails.notEquals=" + DEFAULT_G_ST_DETAILS);

        // Get all the securityUserList where gSTDetails not equals to UPDATED_G_ST_DETAILS
        defaultSecurityUserShouldBeFound("gSTDetails.notEquals=" + UPDATED_G_ST_DETAILS);
    }

    @Test
    @Transactional
    void getAllSecurityUsersBygSTDetailsIsInShouldWork() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where gSTDetails in DEFAULT_G_ST_DETAILS or UPDATED_G_ST_DETAILS
        defaultSecurityUserShouldBeFound("gSTDetails.in=" + DEFAULT_G_ST_DETAILS + "," + UPDATED_G_ST_DETAILS);

        // Get all the securityUserList where gSTDetails equals to UPDATED_G_ST_DETAILS
        defaultSecurityUserShouldNotBeFound("gSTDetails.in=" + UPDATED_G_ST_DETAILS);
    }

    @Test
    @Transactional
    void getAllSecurityUsersBygSTDetailsIsNullOrNotNull() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where gSTDetails is not null
        defaultSecurityUserShouldBeFound("gSTDetails.specified=true");

        // Get all the securityUserList where gSTDetails is null
        defaultSecurityUserShouldNotBeFound("gSTDetails.specified=false");
    }

    @Test
    @Transactional
    void getAllSecurityUsersBygSTDetailsContainsSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where gSTDetails contains DEFAULT_G_ST_DETAILS
        defaultSecurityUserShouldBeFound("gSTDetails.contains=" + DEFAULT_G_ST_DETAILS);

        // Get all the securityUserList where gSTDetails contains UPDATED_G_ST_DETAILS
        defaultSecurityUserShouldNotBeFound("gSTDetails.contains=" + UPDATED_G_ST_DETAILS);
    }

    @Test
    @Transactional
    void getAllSecurityUsersBygSTDetailsNotContainsSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);

        // Get all the securityUserList where gSTDetails does not contain DEFAULT_G_ST_DETAILS
        defaultSecurityUserShouldNotBeFound("gSTDetails.doesNotContain=" + DEFAULT_G_ST_DETAILS);

        // Get all the securityUserList where gSTDetails does not contain UPDATED_G_ST_DETAILS
        defaultSecurityUserShouldBeFound("gSTDetails.doesNotContain=" + UPDATED_G_ST_DETAILS);
    }
    ...
    @Test
    @Transactional
    void getAllSecurityUsersByPurchaseOrderDetailsIsEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);
        PurchaseOrder purchaseOrderDetails;
        if (TestUtil.findAll(em, PurchaseOrder.class).isEmpty()) {
            purchaseOrderDetails = PurchaseOrderResourceIT.createEntity(em);
            em.persist(purchaseOrderDetails);
            em.flush();
        } else {
            purchaseOrderDetails = TestUtil.findAll(em, PurchaseOrder.class).get(0);
        }
        em.persist(purchaseOrderDetails);
        em.flush();
        securityUser.addPurchaseOrderDetails(purchaseOrderDetails);
        securityUserRepository.saveAndFlush(securityUser);
        Long purchaseOrderDetailsId = purchaseOrderDetails.getId();

        // Get all the securityUserList where purchaseOrderDetails equals to purchaseOrderDetailsId
        defaultSecurityUserShouldBeFound("purchaseOrderDetailsId.equals=" + purchaseOrderDetailsId);

        // Get all the securityUserList where purchaseOrderDetails equals to (purchaseOrderDetailsId + 1)
        defaultSecurityUserShouldNotBeFound("purchaseOrderDetailsId.equals=" + (purchaseOrderDetailsId + 1));
    }
    ...
    @Test
    @Transactional
    void getAllSecurityUsersByProductQuatationIsEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);
        ...
        em.persist(productQuatation);
        em.flush();
        securityUser.setProductQuatation(productQuatation);
        productQuatation.setSecurityUser(securityUser);
        securityUserRepository.saveAndFlush(securityUser);
        Long productQuatationId = productQuatation.getId();

        // Get all the securityUserList where productQuatation equals to productQuatationId
        defaultSecurityUserShouldBeFound("productQuatationId.equals=" + productQuatationId);

        // Get all the securityUserList where productQuatation equals to (productQuatationId + 1)
        defaultSecurityUserShouldNotBeFound("productQuatationId.equals=" + (productQuatationId + 1));
    }

    @Test
    @Transactional
    void getAllSecurityUsersByTransferIsEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);
        Transfer transfer;
        ...
        em.persist(transfer);
        em.flush();
        securityUser.setTransfer(transfer);
        securityUserRepository.saveAndFlush(securityUser);
        Long transferId = transfer.getId();

        // Get all the securityUserList where transfer equals to transferId
        defaultSecurityUserShouldBeFound("transferId.equals=" + transferId);

        // Get all the securityUserList where transfer equals to (transferId + 1)
        defaultSecurityUserShouldNotBeFound("transferId.equals=" + (transferId + 1));
    }

    @Test
    @Transactional
    void getAllSecurityUsersByConsumptionDetailsIsEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);
        ...
        em.persist(consumptionDetails);
        em.flush();
        securityUser.setConsumptionDetails(consumptionDetails);
        securityUserRepository.saveAndFlush(securityUser);
        Long consumptionDetailsId = consumptionDetails.getId();

        // Get all the securityUserList where consumptionDetails equals to consumptionDetailsId
        defaultSecurityUserShouldBeFound("consumptionDetailsId.equals=" + consumptionDetailsId);

        // Get all the securityUserList where consumptionDetails equals to (consumptionDetailsId + 1)
        defaultSecurityUserShouldNotBeFound("consumptionDetailsId.equals=" + (consumptionDetailsId + 1));
    }
    ...
    void putNewSecurityUser() throws Exception {
        ...
        assertThat(testSecurityUser.getBusinessTitle()).isEqualTo(UPDATED_BUSINESS_TITLE);
        assertThat(testSecurityUser.getgSTDetails()).isEqualTo(UPDATED_G_ST_DETAILS);
